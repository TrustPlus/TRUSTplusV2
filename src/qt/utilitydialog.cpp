    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("TRUSTplus Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About TRUSTplus Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  trustplus-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the TRUSTplus in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
PrivateSend uses an trustplustive process to mix your inputs with the inputs of two other people, without having your coins ever leave your wallet. \
...
For more info see <a href=\"https://trustpluscoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://trustpluscoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("TRUSTplus Core is shutting down...") + "<br /><br />" +
