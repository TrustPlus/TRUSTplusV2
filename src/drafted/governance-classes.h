 ...
 *
 *   // network
 *   CTRUSTplusNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.trustpluscoin.info/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CTRUSTplusNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CTRUSTplusNetwork(UniValue objIn)
    {
...
// // can be under: TRUSTplusNetwork
// //   -- signature requirements : Key1(User)
// class CTRUSTplusNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == TRUSTplusNetwork);
//     // }
