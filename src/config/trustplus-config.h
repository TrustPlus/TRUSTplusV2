...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The TRUSTplus Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "TRUSTplus Core"
...
#define PACKAGE_BUGREPORT "https://github.com/NicholasAdmin/TRUSTplus/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "TRUSTplus Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "TRUSTplus Core 1.0.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "trustpluscore"
